              ...
              <div>
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-4 text-lg text-gray-500">
                    Streamline your hiring process with our intelligent recruitment system.
                    Upload job descriptions, analyze resumes, and find the best candidates
                    with AI matching technology.
                  </p>
              ...
              <div className="pt-6">
                <div className="flow-root bg-white rounded-lg px-6 pb-8 shadow-lg">
                  <div className="-mt-6">
                    ...
                    <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Job Description Analysis</h3>
                    <p className="mt-5 text-base text-gray-500">
                      Upload your job descriptions and our AI will extract key requirements, skills, and responsibilities.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-white rounded-lg px-6 pb-8 shadow-lg">
                  <div className="-mt-6">
                    ...
                    <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Resume Parsing</h3>
                    <p className="mt-5 text-base text-gray-500">
                      Extract candidate information automatically from resumes with high accuracy.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-white rounded-lg px-6 pb-8 shadow-lg">
                  <div className="-mt-6">
                    ...
                    <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">AI Matching</h3>
                    <p className="mt-5 text-base text-gray-500">
                      Match candidates to job descriptions with intelligent scoring and ranking.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="bg-blue-600">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg leading-6 text-blue-100">
            Upload job descriptions and resumes to get started with intelligent candidate matching.
          </p>
          <Link
            to="/upload"
